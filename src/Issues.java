...
public class Issues extends javax.swing.JInternalFrame {
    ...
    private void loadTable(){
        ...
        try{
            ...
            String sql ="SELECT `issueid`, `memberid`, `membername`, `isbn`, `bookname`, `issuedate`, `duedate` FROM `issue`";
     ...
     private void SearchMember(){
      ...
      private void SearchBook(){
        ...
        try{
            ...
            String sql="SELECT * FROM `book` WHERE isbn= '"+id+"' && type ='borrow'";
           ...
           rs=pst.executeQuery();
            ...
            JOptionPane.showMessageDialog(null, "Incorrect ID or Invalid Type");
        }
